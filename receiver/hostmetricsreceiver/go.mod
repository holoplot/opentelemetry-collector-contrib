...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/winperfcounters v0.126.0
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/golden v0.126.0 // indirect
