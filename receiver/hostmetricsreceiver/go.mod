...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/filter v0.134.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/winperfcounters v0.134.0
	...
	go.opentelemetry.io/collector/scraper/scrapertest v0.134.0
